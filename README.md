...
sfdx-kgo-plugin/0.0.3 win32-x64 node-v14.15.4
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/kgo/data/count.ts](https://github.com/KevinGossentCap/sfdx-kgo-plugin/blob/v0.0.3/src/commands/kgo/data/count.ts)_
<!-- commandsstop -->
